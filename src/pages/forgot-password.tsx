...
const ForgotPassword: NextPage = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center">
      <header className="flex h-[70px] w-full justify-center font-bold text-black">
      ...
      <div className="flex w-full grow flex-col items-center gap-5 px-5 pt-5 sm:w-96 sm:pt-52">
        ...
        <div className="flex w-full flex-col gap-2">
          <input
            ...
            placeholder="Email"
          />
          <button className="w-full rounded-2xl border-b-4 border-[#235390] bg-[#0046ff] py-3 font-bold uppercase text-white transition hover:bg-[#003bdf]">
            Submit
          </button>
        </div>
      </div>
